...
const getEventosPorCategoria = async (req, res) => {
  try {
    ...
    const conteo = `
      ...
      WHERE c.categoria = @categoria AND e.id_estadoRealizacion=1 AND e.id_estadoAprobacion=2;
      `;
    ...
    const consulta = `
      ...
      WHERE c.categoria = @categoria AND e.id_estadoRealizacion=1 AND e.id_estadoAprobacion=2 AND i.id_tipoImagen = 1
